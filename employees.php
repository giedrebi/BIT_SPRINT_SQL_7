...
<body>
    ...
    if (mysqli_num_rows($result) > 0) {
        print("<table>");
        print("<thead>");
        print("<tr><th>ID</th><th>NAME AND SURNAME</th><th>PROJECT</th><th>ACTIONS</th></tr>");
        print("</thead>");
        print("<tbody>");
        while ($row = mysqli_fetch_assoc($result)) {
            print('<tr>'
                ...
                . '<a href="updateEmployee.php?id=' . $row['id'] . '"><button class="btn update">UPDATE</button></a>'
                . '</td>'
                . '</tr>');
        }
        print("</tbody>");
    ...
    ?>
    <a href="createEmployee.php"><button class="btn add">ADD NEW EMPLOYEE</button></a>
